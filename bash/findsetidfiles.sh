...
echo "My sorted list of 12 biggest files:"
echo "================================================================"
echo "File Size        File Owner     File Name "
echo "----------------------------------------------------------------"
find / -type f -executable -perm -4000 -ls 2>/dev/null | sort -h -r | head -n 12 | awk '{print $1," \t "$3," \t"$11}'
